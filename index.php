...
// Yönetici panelinden eklenen en güncel reklamı ana sayfada göster.
$guncelReklam = $conn->query("SELECT Reklam FROM reklam ORDER BY ReklamID DESC LIMIT 1")->fetch_assoc();
?>
...
<div class="site-wrap">
    ...
    <?php if (!empty($guncelReklam['Reklam'])): ?>
    <div class="container-fluid text-center py-2" style="background:#89ba16; color:#fff;">
      <?php echo htmlspecialchars($guncelReklam['Reklam']); ?>
    </div>
    <?php endif; ?>
